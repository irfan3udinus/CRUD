...
public class UpdateClient {
    ...
    public static void main(String[] args) throws UniformInterfaceException
    {
        ...
        // cari data yang ingin diubah sesuai IDnya , misal id ke 2
        ClientResponse respon = client1.find_XML(ClientResponse.class,"2");
        GenericType<Todolist> genericType = new GenericType<Todolist>() {};
        
        Todolist tdl = respon.getEntity(genericType);
            ...
            tdl.setKerjaan("Presentasi Proyek Akhir");
            tdl.setTempat("Mejanya Pak Fahri");
            client1.edit_XML(tdl);
